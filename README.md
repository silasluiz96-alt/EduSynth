...
### v2 — Planned (analytics layer + communication)
- [ ] dbt models (staging + marts) over DuckDB session data
- [ ] Session report delivered by e-mail via SendGrid — optional, requested at session end
- [ ] Long-term weak-points map — track evolution across sessions
- [ ] Weekly/monthly performance dashboard with visualizations
